...
constexpr const char* const ReaderSettingsView::TOGGLE_VALUES[];
constexpr const char* const ReaderSettingsView::AUTO_TURN_MODE_VALUES[];
constexpr const char* const ReaderSettingsView::AUTO_TURN_WPM_VALUES[];

const ReaderSettingsView::SettingDef ReaderSettingsView::DEFS[SETTING_COUNT] = {
    {"Theme", SettingType::ThemeSelect, nullptr, 0},
    {"Font Size", SettingType::Enum, FONT_SIZE_VALUES, 2},
    ...
    {"Tilt Page Turn", SettingType::Toggle, nullptr, 0},
    {"Auto Page Turn", SettingType::Enum, AUTO_TURN_MODE_VALUES, 2},
    {"Reading WPM", SettingType::Enum, AUTO_TURN_WPM_VALUES, 5},
};
